...
use crate::gateway::studio::router::handlers::repo::analysis::search::service::run_repo_symbol_search;
...
pub async fn symbol_search(
    ...
    let result = run_repo_symbol_search(Arc::clone(&state), repo_id, search_query, limit).await?;
    Ok(Json(result))
}
