...
// Coactivation runtime controls
pub(crate) const LINK_GRAPH_COACTIVATION_ENABLED_ENV: &str =
    "XIUXIAN_WENDAO_LINK_GRAPH_COACTIVATION_ENABLED";
pub(crate) const LINK_GRAPH_COACTIVATION_ALPHA_SCALE_ENV: &str =
    "XIUXIAN_WENDAO_LINK_GRAPH_COACTIVATION_ALPHA_SCALE";
pub(crate) const LINK_GRAPH_COACTIVATION_MAX_NEIGHBORS_PER_DIRECTION_ENV: &str =
    "XIUXIAN_WENDAO_LINK_GRAPH_COACTIVATION_MAX_NEIGHBORS_PER_DIRECTION";
pub(crate) const LINK_GRAPH_COACTIVATION_MAX_HOPS_ENV: &str =
    "XIUXIAN_WENDAO_LINK_GRAPH_COACTIVATION_MAX_HOPS";
pub(crate) const LINK_GRAPH_COACTIVATION_MAX_TOTAL_PROPAGATIONS_ENV: &str =
    "XIUXIAN_WENDAO_LINK_GRAPH_COACTIVATION_MAX_TOTAL_PROPAGATIONS";
pub(crate) const LINK_GRAPH_COACTIVATION_HOP_DECAY_SCALE_ENV: &str =
    "XIUXIAN_WENDAO_LINK_GRAPH_COACTIVATION_HOP_DECAY_SCALE";
pub(crate) const LINK_GRAPH_COACTIVATION_TOUCH_QUEUE_DEPTH_ENV: &str =
    "XIUXIAN_WENDAO_LINK_GRAPH_COACTIVATION_TOUCH_QUEUE_DEPTH";
pub(crate) const DEFAULT_LINK_GRAPH_COACTIVATION_ENABLED: bool = false;
pub(crate) const DEFAULT_LINK_GRAPH_COACTIVATION_ALPHA_SCALE: f64 = 0.5;
pub(crate) const DEFAULT_LINK_GRAPH_COACTIVATION_MAX_NEIGHBORS_PER_DIRECTION: usize = 32;
pub(crate) const DEFAULT_LINK_GRAPH_COACTIVATION_MAX_HOPS: usize = 1;
pub(crate) const DEFAULT_LINK_GRAPH_COACTIVATION_HOP_DECAY_SCALE: f64 = 0.5;
pub(crate) const DEFAULT_LINK_GRAPH_COACTIVATION_TOUCH_QUEUE_DEPTH: usize = 256;
