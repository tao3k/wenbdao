...
#[must_use]
pub fn suggested_link_signature_from_request(request: &LinkGraphSuggestedLinkRequest) -> String {
...
#[must_use]
pub fn suggested_link_signature_from_row(row: &LinkGraphSuggestedLink) -> String {
