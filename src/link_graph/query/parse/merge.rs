...
pub(super) fn merge_into_base(
    ...
    let related_has_ppr = has_related_ppr_options(&state.related_ppr);
    if base.filters.related.is_none() {
        ...
        if base_related.ppr.is_none() && related_has_ppr {
